...
class CoffeeRepositoryImpl implements CoffeeRepository {
  ...
  final List<Map<String, dynamic>> _dummyData2 = [
    ...
    },
    {
      ...
      'price': 6.10,
      'image':
          'https://images.unsplash.com/photo-1509042239860-7b3f9c58d3b0?w=400',
      'rating': 4.6,
      'category': 'Cold',
    },
    {
    ...
    },
    {
      ...
      'price': 6.75,
      'image':
          'https://images.unsplash.com/photo-1510627498534-cf7e9002facc?w=400',
      'rating': 4.7,
      'category': 'Cold',
    },
  ];
  ...
  Future<List<CoffeeEntity>> getCoffeeList({String? storeId}) async {
    ...
    return _dummyData
        .map((json) => CoffeeModel.fromJson(json).toEntity())
        .toList();
  }
