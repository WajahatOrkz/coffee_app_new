// import 'package:coffee_app/features/domain/repositories/coffee_repositories.dart';
...
//   //     isLoading.value = true;
//   //     final list = await repository.getCoffeeByCategory(category);
//   //    searchedCoffeeList = list;
//   //   } catch (e) {
//   //     Get.snackbar('Error', e.toString());
//   //   } finally {
//   //     isLoading.value = false;
...
//     if (query.isEmpty) {
//       // Agar search empty hai to original list show karo
//       searchedCoffeeList.value = allCoffeeList;
//     } else {
//       // Search query ke basis pe filter karo
//       searchedCoffeeList.value = allCoffeeList.where((coffee) {
//         final nameLower = coffee.name.toLowerCase();
//         final subtitleLower = coffee.subtitle.toLowerCase();
